			...
			items: [
				{
					...
					price: "$18",
					desc: "Crispy risotto balls with truffle oil and parmesan.",
				},
				{
					name: "Seared Scallops",
					price: "$24",
					desc: "Hokkaido scallops with pea puree and pancetta.",
				},
			],
		},
		{
			...
			items: [
				{
					name: "Wagyu Ribeye",
					price: "$65",
					desc: "Grade A5 wagyu served with roasted bone marrow.",
				},
				{
					name: "Lobster Thermidor",
					price: "$58",
					desc: "Atlantic lobster in a rich brandy cream sauce.",
				},
			],
		},
		{
			...
			items: [
				{
					...
					price: "$16",
					desc: "Dark chocolate lava cake with edible 24k gold.",
				},
				{
					name: "Lemon Yuzu Tart",
					price: "$14",
					desc: "Zesty yuzu curd with toasted swiss meringue.",
				},
			],
		},
	]
		...
		<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
			<div class="flex flex-col gap-12 lg:gap-16">
				...
				<div class="space-y-4 max-w-3xl">
					...
					<p
						class="text-neutral-600 dark:text-neutral-400 text-base sm:text-lg leading-relaxed"
					>
						Embark on a culinary journey where every dish tells a story of
						tradition and innovation. Our Michelin-starred restaurant offers a
				...
				>
					...
					>
						...
						<div class="flex justify-between items-baseline gap-4">
							...
							<span
								class="font-bold text-lg text-primary-600 whitespace-nowrap"
							>
								{{ item.rate }}
							</span>
						</div>
