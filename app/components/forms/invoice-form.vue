	...
	>
		<div class="flex flex-col items-center space-y-4">
			<u-card style="max-width: 700px; min-width: min(90vw, 700px)">
				...
				<u-form-field label="Discount amount" name="discount_amount">
					<u-input
			...
			<UCard
				style="max-width: 700px; min-width: min(85vw, 700px); overflow: auto"
			>
			...
			<UCard style="max-width: 700px; min-width: min(90vw, 700px)">
				<div class="flex justify-end space-x-2">
					<u-button
						...
						@click="
							() => {
								if (useRoute().name == 'hotels-invoices-id-form') {
									useRouter().push({
